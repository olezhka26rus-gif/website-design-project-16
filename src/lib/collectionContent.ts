...
export const buildCollectionContent = (
  ...
  if (mode === 'country') {
    ...
    faq.push({
      q: `Обязательно ли везти машину именно из ${gen}?`,
      a: `Нет. Одна и та же модель часто продаётся сразу на нескольких рынках, поэтому марка автомобиля не определяет страну покупки. ` +
        `Мы сравниваем цену под ключ по всем доступным маршрутам и предлагаем самый выгодный — иногда это ${gen}, иногда другая страна. ` +
        `На странице каждой модели есть таблица сравнения по странам.`,
    });
    ...
    faq.push({
      q: `${brandName} обязательно везти со своего домашнего рынка?`,
      a: `Нет. Марка автомобиля не определяет страну покупки: ${brandName} продаётся сразу на нескольких рынках. ` +
        `Мы считаем стоимость под ключ по каждому доступному маршруту и выбираем самый выгодный — на странице модели есть таблица сравнения по странам.`,
    });
