...
const cases: {
  ...
  {
    name: 'BYD Song Max 2021',
    spec: '1.5T CVT',
    countryCode: 'china',
    countryName: 'Китай',
    priceAbroad: '1 550 000 ₽',
    priceRu: '2 690 000 ₽',
    ourPrice: '1 910 000 ₽',
    save: '780 000 ₽',
    days: '33 дня',
    image: '/vehicles/china-byd-song-plus-side.webp',
  },
  {
    ...
    save: '750 000 ₽',
    days: '45 дней',
    image: '/vehicles/korea-hyundai-elantra-side.webp',
  },
  {
    name: 'Volvo XC60 2025',
    spec: '2.0T B5 AWD',
    countryCode: 'china',
    countryName: 'Китай',
    priceAbroad: '5 950 000 ₽',
    priceRu: '8 200 000 ₽',
    ourPrice: '6 500 000 ₽',
    save: '1 700 000 ₽',
    days: '38 дней',
    image: 'https://cdn.poehali.dev/projects/075c969b-4b51-4419-a74f-b3f2f4b044ae/files/b30b5794-86e6-4f53-9be8-e197ea24356f.jpg',
  },
  {
    name: 'BMW X5 2023',
